...
<!--======================================-->
<nav>
<p id="title"><b>[잇츠 오사카타임]◇온천호텔2박+노팁+1일자유◇ 오사카,교토,아라시야마 3일</b></p>

<hr>
	<p>상품번호 | JKP1505-230820TW00</p>
	<p>● 타사비교 필수! 필수여행지 교토+아라시야마 관광 기본포함<br>
		● 짧고 굵게 즐기는 1일자유 DIY 여행가능<br>
		● 부담없는 가이드팁 포함</p>

	<img src="<%=vImgUrl%>japan02_01.png">
	<img src="<%=vImgUrl%>japan02_02.png">
	<img src="<%=vImgUrl%>japan02_03.png">
</nav>
...
<p>상품 안내</p>
<img src="<%=vImgUrl%>japan02_ex.png">
...
<table id="infor">
	<tr>
		<td><b>출발</b></td>
		<td>2023.09.05 (화) 16:10</td>
	<tr>
	<tr>
		<td><b>도착</b></td>
		<td>2023.09.07 (목) 21:00</td>
	<tr>
	<tr>
		<td><b>교통</b></td>
		<td>진에어</td>
