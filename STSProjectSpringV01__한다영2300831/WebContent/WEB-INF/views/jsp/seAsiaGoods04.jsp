...
<!--======================================-->
<nav>
<p id="title"><b>[단독] 싱가포르 프리미엄 특급호텔 1일자유 5일 (NO팁/NO옵션/NO쇼핑)</b></p>

<hr>

	<p>상품번호 | SP1077-230910TW00</p>
	<p>불필요한 추가비용은 NO!!</p>
	<p>핵심 관광지는 모두 포함!! 1일 자유일정 까지!!</p>

<img src="<%=vImgUrl %>seAsia04_01.png">
<img src="<%=vImgUrl %>seAsia04_02.png">
<img src="<%=vImgUrl %>seAsia04_03.png">
</nav>
...
<p>상품 안내</p>
<img src="<%=vImgUrl %>seAsia04_ex.png">
...
<table id="infor">
	<tr>
		<td><b>출발</b></td>
		<td>2023.08.31 (목) 09:25</td>
	<tr>
	<tr>
		<td><b>도착</b></td>
		<td>2023.09.04 (월) 05:55</td>
	<tr>
	<tr>
		<td><b>교통</b></td>
		<td>라오항공</td>
