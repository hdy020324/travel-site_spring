...
<!--======================================-->
<nav>
<p id="title"><b>[★출발확정★]◇온야도교토+가이유칸수족관+간식비제공◇ 오사카,교토 3일</b></p>

<hr>
	<p>상품번호 | JOP1219-230912TW00</p>
	<p>노옵션 상품으로 가볍게 즐길 수 있는 큐슈 핵심지역 상품</p>

<img src="<%=vImgUrl%>japan04_01.png">
<img src="<%=vImgUrl%>japan04_02.png">
<img src="<%=vImgUrl%>japan04_03.png">
</nav>
...
<table id="secT01">
	...
	<tr>
		<td>방문도시</td>
		<td>인천 → 간사이 → 교토(1) → 아라시야마 → 오사카(1) → 고베 → 오사카 → 간사이 → 인천</td>
	</tr>
	<tr>
		<td>예약현황</td>
		<td>예약 : 17석 남은좌석 : 17석 ( 최소출발 15명 )</td>
	</tr>
</table>
...
<p>상품 안내</p>
<img src="<%=vImgUrl%>japan04_ex.png">
<img src="<%=vImgUrl%>japan04_ex02.png">
</section>
...
<table id="infor">
	<tr>
		<td><b>출발</b></td>
		<td>2023.09.12 (화) 15:40</td>
	<tr>
	<tr>
		<td><b>도착</b></td>
		<td>2023.09.14 (목) 20:20</td>
	<tr>
	<tr>
		<td><b>교통</b></td>
		<td>티웨이항공</td>
