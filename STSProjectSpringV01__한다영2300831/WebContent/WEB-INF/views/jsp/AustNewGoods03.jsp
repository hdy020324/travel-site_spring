...
<!--======================================-->
<nav>
<p id="title"><b>뉴질랜드 남/북섬 9일 #자연그대로 #온천 #밀포드사운드</b></p>

<hr>

	<p>상품번호 |  PNP1031-230916KE00</p>
	<p>◆ 백신 미접종자도 출발 전 코로나 검사없이도 여행 가능!</p>
	<p>◆ 대한항공 직항으로 편안한 여행</p>
	<p>◆ 뉴질랜드 남,북섬 항공이동으로 편안하게 여행</p>
	<p>◆ 뉴질랜드 남,북섬 필수 관광지 포함, 알찬 일정!!</p>
	<p>◆ 뉴질랜드 다양한 현지식, 이국적인 도시 그리고 아름다운 자연과 함께 레스토랑에서 식사</p>
	
<img src="<%=vImgUrl %>AustNew03_01.png">
<img src="<%=vImgUrl %>AustNew03_02.png">
<img src="<%=vImgUrl %>AustNew03_03.png">
</nav>
...
<table id="secT01">
	...
	<tr>
		<td>방문도시</td>
		<td>인천 → 퀸스타운(2박) → 크라이스트처치(1박) → 오클랜드(1박) → 로토루아(2박) → 오클랜드(1박) → 인천</td>
	</tr>
	<tr>
		<td>예약현황</td>
		<td>예약 : 0석    남은좌석 : 20석 ( 최소출발 10명 )</td>
	</tr>
</table>
...
<p>상품 안내</p>
<img src="<%=vImgUrl %>AustNew03_ex01.png">
