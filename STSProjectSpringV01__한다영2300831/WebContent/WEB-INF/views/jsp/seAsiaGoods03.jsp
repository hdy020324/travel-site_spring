...
<!--======================================-->
<nav>
<p id="title"><b>[발리/NO쇼핑]누사두아위치 품격이 다른 물리아 리조트 6일</b></p>

<hr>

	<p>상품번호 | AIP1061-231019KE00</p>
	<p>#품격이 다른 리조트 #전용비치 보유 #재방문 1위 #커플여행</p>

<img src="<%=vImgUrl %>seAsia01_01.png">
<img src="<%=vImgUrl %>seAsia01_02.png">
<img src="<%=vImgUrl %>seAsia01_03.png">
</nav>
...
<p>상품 안내</p>
<img src="<%=vImgUrl %>seAsia03_ex.png">
...
<table id="infor">
	<tr>
		<td><b>출발</b></td>
		<td>2023.10.19 (목) 17:50</td>
	<tr>
	<tr>
		<td><b>도착</b></td>
		<td>2023.10.24 (화) 09:20</td>
	<tr>
	<tr>
		<td><b>교통</b></td>
		<td>라오항공</td>
