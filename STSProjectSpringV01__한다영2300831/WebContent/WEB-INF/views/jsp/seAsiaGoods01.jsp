...
<!--======================================-->
<nav>
<p id="title"><b>[라오스] 비엔티엔/방비엥+블루라군+카약킹+마사지 5일</b></p>

<hr>

	<p>상품번호 ALP1046-230831QV00</p>
...
<table id="secT01">
	...
	<tr>
		<td>방문도시</td>
		<td>인천 → 비엔티엔(1) → 방비엥(2) → 인천</td>
	</tr>
	<tr>
		<td>예약현황</td>
		<td>	예약 : 0석    남은좌석 : 10석 ( 최소출발 6명 )</td>
	</tr>
</table>
...
<p>상품 안내</p>
<img src="<%=vImgUrl %>seAsia01_ex.png">
