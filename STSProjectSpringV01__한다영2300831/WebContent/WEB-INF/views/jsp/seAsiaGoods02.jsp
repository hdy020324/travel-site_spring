...
<!--======================================-->
<nav>
<p id="title"><b>[코타키나발루/초특급/써차지포함]샹그릴라 탄중아루 호핑투어+자유일정 씨뷰UP! 5일</b></p>

<hr>

	<p>상품번호 | AMP3107-230904TW00</p>
	<p>월드체인 샹그릴라 탄중아루</p>
	<p>당신의 선택은? 관광도, 휴양도 원하시는 분들은 이 상품으로 예약하세요~!</p>

<img src="<%=vImgUrl %>seAsia02_01.png">
<img src="<%=vImgUrl %>seAsia02_02.png">
<img src="<%=vImgUrl %>seAsia02_03.png">
</nav>
...
<p>상품 안내</p>
<img src="<%=vImgUrl %>seAsia02_ex.png">
<img src="<%=vImgUrl %>seAsia02_ex02.png">
<img src="<%=vImgUrl %>seAsia02_ex03.png">
<img src="<%=vImgUrl %>seAsia02_ex04.png">
...
<table id="infor">
	<tr>
		<td><b>출발</b></td>
		<td>2023.09.04 (월) 18:45</td>
	<tr>
	<tr>
		<td><b>도착</b></td>
		<td>2023.09.08 (금) 06:30</td>
	<tr>
	<tr>
		<td><b>교통</b></td>
		<td>라오항공</td>
