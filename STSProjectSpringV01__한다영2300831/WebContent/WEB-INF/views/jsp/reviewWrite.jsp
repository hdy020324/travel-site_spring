...
<section>
<form action="<%=vUrl%>/reviewWrite">
<input type="hidden" name="category" value="writeReview">
<input type="hidden" name="gue_id" value="${mem_id}">
<input type="hidden" name="gue_pwd" value="${mem_pwd} }">
 ...
 <article id="write">
	<table>
		<tr>
			...
			<td><input type="text"  name="gue_subject" placeholder=" 제목을 입력하세요."></td>
		</tr>
		<tr>
			<td class="title">내용</td>
			<td><textarea maxlength="1000" name="gue_content"></textarea></td>		
		</tr>
	</table>
	
	<p><span>1000자 이내 작성<span></p>
	<p><input type="submit" value="등록" class="button"><input type="button" value="취소" class="button"></p>
 </article>
</form>
</section>
